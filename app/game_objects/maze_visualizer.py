...
class MazeVisualizer(GameObject):
    def __init__(self, x, y, data, width, height, start_coordinates, goal_coordinates, wall_color=(0, 0, 0), path_color=(255, 255, 255), 
                player_color=(255, 0, 0), player_coords=(0, 0), start_color = (0, 255, 0), goal_color = (0, 255, 255), **kwargs):
        ...
        :param tuple player_coords: The coordinates of the player in the maze, as a tuple of two integers.
    ...
    def draw(self, screen):
        ...
        player_rect = pygame.Rect(self.x + self.player_coords[1] * self.cell_size, self.y + self.player_coords[0] * self.cell_size, self.cell_size, self.cell_size)
